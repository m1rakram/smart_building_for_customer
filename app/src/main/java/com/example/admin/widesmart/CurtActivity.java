...
public class CurtActivity extends AppCompatActivity {
    ...
    CurtActivity.MyMqttCallBack mqtt = new  CurtActivity.MyMqttCallBack();
    public SharedPreferences info;
    public VerticalSeekBar v1;
    public ImageView imagecur;
    public LinearLayout sf2, cauto;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cauto=(LinearLayout) findViewById(R.id.cauto);
        ...
        sf2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                publishData("2#"+seekvalue, publish_topic5);
            }
        });
